function outPath = xcorrByWin(inPath,outPath,exportInfo,overlapRatio)

% BUILD 36:
% - Lets the user pick the overlap ratio by passing it in as an argument.
...
if abs(nargin) < 4 || isempty(overlapRatio)
    overlapRatio = 0;
end
...
if exist('exportInfo','var') && ~isempty(exportInfo)
