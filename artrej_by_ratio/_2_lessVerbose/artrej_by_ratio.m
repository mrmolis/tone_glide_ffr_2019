...
if nSweeps <= targetAcc
    disp('No artifact rejection necessary!');
    out = in;
    nAcc = nSweeps;
    nRej = nTotal - nSweeps;
    rejThreshold = [];
    msg = ['TH: ???; nAcc: ' num2str(nAcc) '; pctAcc: ' ...
        num2str(100*nAcc/nTotal) '; targetPctAcc: '...
        num2str(100*(1-rejRatio))];
    disp(msg);
    return
end
...
%         '; pctAcc: ' num2str(100*nAcc/nTotal) '; targetPctAcc: '...
%         num2str(100*(1-rejRatio))];
%     disp(msg);
